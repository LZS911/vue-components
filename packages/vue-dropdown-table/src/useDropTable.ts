...
import { defaultTableHeight, defaultTableWidth, ISizeMap, TSizeMap } from './index.data';
...
export default function useDropTable(props: ILyDropTableProps, emit: (event: string, ...args: any[]) => void) {
  ...
  const dropDisable = computed(() => !!props.disabled);
