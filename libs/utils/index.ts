import type { ComponentSize, SFCWithInstall, RefElement, ITableColumn, ITable, IStyle } from './index.d';
import { SizeEnum, KeyCodeEnum } from './enum';
import { isString, toRawType } from '@vue/shared';
import { Ref, computed } from 'vue';
import { isEmpty as lodashIsEmpty, remove } from 'lodash';
...
export { isString };
export { SizeEnum, KeyCodeEnum };
export type { ComponentSize, SFCWithInstall, RefElement, ITableColumn, ITable, IStyle };
...
export const arrRemove = <T>(arr: T[], val: T): T[] => remove(arr, (t) => t !== val);
